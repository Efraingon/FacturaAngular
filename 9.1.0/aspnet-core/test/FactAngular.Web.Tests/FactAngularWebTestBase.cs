...
{
    public abstract class FactAngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FactAngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FactAngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FactAngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FactAngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FactAngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FactAngularDbContext, Task<T>> func)
        {
            T result;

...
namespace FactAngular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly FactAngularDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = FactAngularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FactAngularDbContext context)
        {
            _context = context;
        }
